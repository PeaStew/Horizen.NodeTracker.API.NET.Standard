...
namespace Horizen.NodeTracker.API.NET.Standard
{
    public static class HorizenNodeAPI
    {
        ...
        */
        public static HorizenNodeAPIDataModels.ServerStats GetServerStats(NodeType nodetype, ServerRegion region = ServerRegion.NONE, ServerNumber number = ServerNumber.NONE)
        {
            return JsonConvert.DeserializeObject<HorizenNodeAPIDataModels.ServerStats>(GetQueryJson(nodetype, region, number, APIPublicCallUrlParts.ServerStats));
        }
        ...
        */
        public static HorizenNodeAPIDataModels.ServerList GetServerList(NodeType nodetype, ServerRegion region = ServerRegion.NONE, ServerNumber number = ServerNumber.NONE)
        {
            return JsonConvert.DeserializeObject<HorizenNodeAPIDataModels.ServerList>(GetQueryJson(nodetype, region, number, APIPublicCallUrlParts.ServerList));
        }
        ...
        */
        public static HorizenNodeAPIDataModels.ServerEarnings GetServerEarnings(NodeType nodetype, ServerRegion region = ServerRegion.NONE, ServerNumber number = ServerNumber.NONE)
        {
            return JsonConvert.DeserializeObject<HorizenNodeAPIDataModels.ServerEarnings>(GetQueryJson(nodetype, region, number, APIPublicCallUrlParts.ServerEarnings));
        }
        ...
        */
        public static HorizenNodeAPIDataModels.ServerOpenChallenges GetServerOpenChallenges(NodeType nodetype, ServerRegion region, ServerNumber number)
        {
            return JsonConvert.DeserializeObject<HorizenNodeAPIDataModels.ServerOpenChallenges>(GetQueryJson(nodetype, region, number, APIPublicCallUrlParts.ServerOpenChallenges));
        }
        ...
        */
        public static HorizenNodeAPIDataModels.NodeCertStatus GetNodeCertStatus(NodeType nodetype, int nodeid, ServerRegion region = ServerRegion.NONE, ServerNumber number = ServerNumber.NONE)
        {
            return JsonConvert.DeserializeObject<HorizenNodeAPIDataModels.NodeCertStatus>(GetQueryJson(nodetype, region, number, APIPublicCallUrlParts.NodeCertStatus(nodeid)));
        }
        #endregion
        ...
        */
        public static HorizenNodeAPIDataModels.NodeDetail GetNodeDetail(APIKey apikey, string category = null, int nodeid = 0, ServerRegion region = ServerRegion.NONE, ServerNumber number = ServerNumber.NONE)
        {
            return JsonConvert.DeserializeObject<HorizenNodeAPIDataModels.NodeDetail>(GetQueryJson(apikey.APINodeType, region, number, APINonPagedCallUrlParts.NodeDetail(apikey, nodeid)));
        }
        ...
        * Expected return: {"id":9,"status":"up","home":"ts1-testnet.na","curserver":"ts1-testnet.na","ip4":"198.58.105.60","ip6":null,"fqdn":"zen1.secnodes.com","config":{"hw":{"CPU":"Intel(R) Xeon(R) CPU E5-2697 v4 @ 2.30GHz","cores":1,"speed":2299},"node":{"version":2001050,"wallet.version":60000,"protocolversion":170002},"trkver":"0.2.1"},"createdAt":"2017-10-16T19:24:11.000Z","updatedAt":"2018-06-13T22:38:25.000Z","taddr":"ztTYagRWzHZuiZxFTuhTgUZigFyoHNBe65s","stkaddr":"ztaj8xNwDjkLxMYWHnWLCvaxHYLmDQzwcxZ","email":"myemail@gmail.com","exceptions":[{"id":40184,"etype":"chalmax","start":"2018-05-02T17:06:40.000Z","check":"2018-06-13T22:40:22.000Z","end":null}],"hasException":true}
        */
        public static HorizenNodeAPIDataModels.MyNodes GetMyNodes(APIKey apikey, string category = null, ServerRegion region = ServerRegion.NONE, ServerNumber number = ServerNumber.NONE, NodeStatus nodestatus = NodeStatus.NONE)
        {
            return JsonConvert.DeserializeObject<HorizenNodeAPIDataModels.MyNodes>(GetQueryJson(apikey.APINodeType, region, number, APINonPagedCallUrlParts.MyNodes(apikey, nodestatus)));
        }
        ...
        */
        public static HorizenNodeAPIDataModels.MyEarnings GetMyEarnings(APIKey apikey, int nodeid = 0, string category = null, ServerRegion region = ServerRegion.NONE, ServerNumber number = ServerNumber.NONE)
        {
            return JsonConvert.DeserializeObject<HorizenNodeAPIDataModels.MyEarnings>(GetQueryJson(apikey.APINodeType, region, number, APINonPagedCallUrlParts.MyEarnings(apikey, nodeid)));
        }
        #endregion
        ...
        */
        public static HorizenNodeAPIDataModels.MyDowntimes GetMyDowntimes(APIKey apikey, int pagenumber, int rowcount, int nodeid = 0, string category = null, DowntimeStatus downtimestatus = DowntimeStatus.NONE, ServerRegion region = ServerRegion.NONE, ServerNumber number = ServerNumber.NONE)
        {
            return JsonConvert.DeserializeObject<HorizenNodeAPIDataModels.MyDowntimes>(GetQueryJson(apikey.APINodeType, region, number, APIPagedCallUrlParts.MyDowntimes(apikey, pagenumber, rowcount, nodeid, downtimestatus)));
        }
        ...
        */
        public static HorizenNodeAPIDataModels.MyExceptions GetMyExceptions(APIKey apikey, int pagenumber, int rowcount, int nodeid = 0, string category = null, ExceptionStatus exceptionstatus = ExceptionStatus.NONE, ServerRegion region = ServerRegion.NONE, ServerNumber number = ServerNumber.NONE)
        {
            return JsonConvert.DeserializeObject<HorizenNodeAPIDataModels.MyExceptions>(GetQueryJson(apikey.APINodeType, region, number, APIPagedCallUrlParts.MyExceptions(apikey, pagenumber, rowcount, nodeid, exceptionstatus)));
        }
        ...
        */
        public static HorizenNodeAPIDataModels.MyChallenges GetMyChallenges(APIKey apikey, int pagenumber, int rowcount, int nodeid = 0, string category = null, ChallengeResult challengestatus = ChallengeResult.NONE, ServerRegion region = ServerRegion.NONE, ServerNumber number = ServerNumber.NONE)
        {
            return JsonConvert.DeserializeObject<HorizenNodeAPIDataModels.MyChallenges>(GetQueryJson(apikey.APINodeType, region, number, APIPagedCallUrlParts.MyChallenges(apikey, pagenumber, rowcount, nodeid, challengestatus)));
        }
        ...
        */
        ...
        public static HorizenNodeAPIDataModels.MyPayments GetMyPayments(APIKey apikey, int pagenumber, int rowcount, int nodeid = 0, string category = null, PaymentStatus paymentstatus = PaymentStatus.NONE, ServerRegion region = ServerRegion.NONE, ServerNumber number = ServerNumber.NONE)
        {
            return JsonConvert.DeserializeObject<HorizenNodeAPIDataModels.MyPayments>(GetQueryJson(apikey.APINodeType, region, number, APIPagedCallUrlParts.MyPayments(apikey, pagenumber, rowcount, nodeid, paymentstatus)));
        }
        #endregion
